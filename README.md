...
The recommended implementation is now split into a ROS-independent
identification core and optional trajectory/simulation adapters. See
[ARCHITECTURE.md](ARCHITECTURE.md) for the current entry point, dependency
boundaries, and command-line example.
