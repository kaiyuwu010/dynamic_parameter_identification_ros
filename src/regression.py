...
class Estimator():
    ...
    def timer_cb_regressor_physical_con(self, positions, velocities, efforts):
        ...
        ineq_constr, constraint_lb, constraint_ub = Estimator.build_ineq_physical_con(
            _estimate, _w0, _w1, _h1, _w2, _h2
        )
        ...
        if not stats.get('success', False):
            raise RuntimeError("physical parameter optimization failed: " +
                               str(stats.get('return_status', 'unknown status')))
