...
def main(args=None):
    ...
    paths = [os.path.join(get_package_share_directory("med7_dock_description")), os.path.join(get_package_share_directory("lbr_description"))]
    ...
    nn_cp = er_state_compensator("/home/thy/learningDynModel/vae_simple_2_VAE_CNN3.pth")
